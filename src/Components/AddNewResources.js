                ...
                <Grid container  >
                    ...
                    <div >
                        ...
                        <div className="row" style={{margin:"0px 0px 10px 0px"}}>
                            <input  style={{width:"13rem",height:"2rem",margin:"6px 0px 1rem 0px",borderRadius:"10px",backgroundColor:"GrayText"}}value={this.state.value} onChange={this.handleChange} />
                        ...
                        <div className="row">
                            <input type="submit" style={{width:"100%",height:"2rem",margin:"1rem 0px 4px 0px",borderRadius:"10px",fontWeight:"bolder", backgroundColor:"crimson",color:"white"} } value="Add Resource" />
                        </div>
                        <div className="row">
