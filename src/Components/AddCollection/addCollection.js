    ...
    return (
        <div>
            ...
            <div className='row ' style={{ textAlign: "right" }}>
                ...
                <Link href="https://www.google.com/" className='share' style={{ color: 'white', textDecoration: "none", margin: "2rem", fontWeight: "bolder" }}>Go back</Link>
            ...
            <div className='row'>
                <Grid container spacing={5} className="centered" >
                    ...
                    <Grid item xs={10} sm={8}>
                        <Paper className="paper coloured" >www.random.com</Paper>
                    </Grid>
                    <Grid item xs={10} sm={8}>
                        <Paper className="paper coloured">www.random.com </Paper>
                    </Grid>
